 ...
 * @description Switch Button for Theme Toggle (KokonutUI style)
 */
...
export function ModeToggle({
  ...
  variant = "minimal",
  size = "default",
  showLabel = false, // Set default to false for navbar integration
  ...props
}: ModeToggleProps) {
      ...
      >
        <Sun
          className={cn(
            ...
            !showLabel && "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
          )}
        />
        {showLabel && (
          <span
