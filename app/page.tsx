      ...
      <main className="relative z-10 container mx-auto px-4 pb-24 pt-10 md:pt-14 lg:pt-16">
            ...
            <div>
              ...
              <div className="mt-10 flex flex-wrap items-center gap-4">
                <a
                  ...
                  className="group inline-flex cursor-pointer items-center gap-2 rounded-2xl border border-primary/50 bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-[0_18px_45px_-20px_rgba(37,99,235,0.75)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_24px_60px_-24px_rgba(37,99,235,0.8)]"
                >
                  {t.primaryCta}
                ...
                <a
                  href="#order-section"
                  className="inline-flex cursor-pointer items-center gap-2 rounded-2xl border border-border/70 bg-background/65 px-5 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted/70"
                >
                  {t.secondaryCta}
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-border/60 bg-card/60 p-8 text-center shadow-[0_24px_80px_-32px_rgba(37,99,235,0.35)] backdrop-blur-xl dark:border-white/10 md:p-12 lg:p-14">
            ...
            <Button
              className="relative mt-8 cursor-pointer rounded-2xl px-8"
              nativeButton={false}
              render={
                <a
